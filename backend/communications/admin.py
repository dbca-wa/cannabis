...
from .models import CommentReaction, Notification, SubmissionComment
...
class SubmissionCommentAdmin(admin.ModelAdmin):
    ...
    def submission_link(self, obj):
        ...
        if obj.submission:
            url = reverse(
                "admin:submissions_submission_change", args=[obj.submission.pk]
            )
    ...
    def author_name(self, obj):
        ...
        if obj.user:
            return (
                obj.user.full_name if hasattr(obj.user, "full_name") else obj.user.email
            )
        return "Unknown"
