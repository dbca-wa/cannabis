...
class CaseAdmin(admin.ModelAdmin):
    ...
    def advance_to_unsigned_generation(self, request, queryset):
        ...
        updated = queryset.update(phase=Case.PhaseChoices.UNSIGNED_GENERATION)
        self.message_user(request, f"{updated} cases moved to unsigned generation")

    advance_to_unsigned_generation.short_description = "Advance to unsigned generation"
    ...
    def mark_complete(self, request, queryset):
        ...
        updated = queryset.update(
            phase=Case.PhaseChoices.COMPLETE, completed_at=timezone.now()
        )
        self.message_user(request, f"{updated} cases marked as complete")
