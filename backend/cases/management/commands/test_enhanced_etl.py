...
class Command(BaseCommand):
    ...
    def run_preprocessing_tests(self, test_records: list):
        ...
        preprocessor.preprocess_all_entities(test_records)
    ...
    def run_array_handling_tests(self, test_records: list):
        ...
        for scenario in test_scenarios:
            ...
            assert drug_bag_data.seal_tag_numbers, "Missing seal_tag_numbers for bag"

            # Validate content type mapping
            assert drug_bag_data.content_type, "Missing content_type for bag"
