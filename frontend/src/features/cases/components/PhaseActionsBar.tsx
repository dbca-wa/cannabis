...
> = {
	data_entry: {
		title: "Data Entry",
		description: "Complete the initial form case with all required information",
	...
	botanist_review: {
		...
		description: "Expert botanist reviews and approves the case details",
	...
	botanist_signoff: {
		...
		description: "Botanist provides final sign-off on the case",
		actionButtonText: "Sign Off",
		actionButtonIcon: CheckCircle2,
	},
	invoicing: {
		title: "Invoicing",
		description: "Generate and process invoices for the case",
		actionButtonText: "Process Invoice",
		actionButtonIcon: FileText,
	},
	send_emails: {
		title: "Send Emails",
...
> = {
	data_entry: {
		...
		description: "Can be advanced by Finance Officers, Botanists, or Admins",
	},
	finance_approval: {
	...
	send_emails: {
		roles: ["Finance Officer", "Botanist", "Admin"],
		description: "Emails can be sent by Finance Officers, Botanists, or Admins",
	},
	complete: {
		roles: [],
			...
			<AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							{currentPhase === "finance_approval" &&
								"Are you sure you want to approve this case financially and send it to the botanist for review?"}
							{currentPhase === "botanist_review" &&
