...
import { CaseStoresProvider } from "../providers/CaseStoresProvider";
import {
	Card,
	CardContent,
	CardHeader,
						...
						<div className="flex items-center gap-2">
							...
							<div>
								...
								<p className="text-xs text-blue-700 dark:text-blue-300">
									You can edit the case details below. Changes will be saved to
									the caseObj.
								</p>
							</div>
						</div>
						...
						<div className="flex items-center gap-2">
							...
							<div>
								...
								<p className="text-xs text-gray-600">
									This is a read-only view of the data entry phase. The case has
									moved to {caseObj.phase_display}.
								</p>
							</div>
						</div>
					</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div>
								...
								<p className="text-base text-gray-900 dark:text-gray-100">
									{caseObj.created_at
										? new Date(caseObj.created_at).toLocaleString()
										: "Unknown"}
								</p>
							</div>
							<div>
								...
								<p className="text-base text-gray-900 dark:text-gray-100">
									{caseObj.updated_at
										? new Date(caseObj.updated_at).toLocaleString()
										: "Unknown"}
								</p>
							</div>
						</div>
					...
					<CardContent className="space-y-4">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div>
								...
								<p className="text-base text-gray-900 dark:text-gray-100">
									{caseObj.submitting_officer_details?.full_name ||
										"Not assigned"}
								</p>
							</div>
							<div>
							...
							<div>
								...
								<p className="text-base text-gray-900 dark:text-gray-100">
									{caseObj.finance_officer_details?.full_name || "Not assigned"}
								</p>
							</div>
						</div>
					</CardContent>
									...
									>
										...
										{defendant.cases_count > 0 && (
											<p className="text-xs text-gray-500">
												{defendant.cases_count} associated case(s)
											</p>
										)}
									</div>
								))}
