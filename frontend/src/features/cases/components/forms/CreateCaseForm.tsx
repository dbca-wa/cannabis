...
import { FileText, Shield, Package, Save, X, Loader2 } from "lucide-react";
...
import type { FormSection } from "../../stores/caseForm.store";
...
export const CreateCaseForm = observer<CreateCaseFormProps>(
	({
		onSubmit,
		onSaveDraft,
		onCancel,
								...
								<div className="text-sm text-muted-foreground flex flex-col">
									{!allTabsComplete && (
										<span className="text-amber-600">
											Complete all tabs (all green checkmarks) to create case
										</span>
									)}
