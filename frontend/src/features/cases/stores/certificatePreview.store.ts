...
export class CertificatePreviewStore {
	...
	constructor() {
		...
		logger.info("CertificatePreviewStore initialised", {
	...
	toggleOption = (option: keyof Omit<CertificateFormatOptions, "template">) => {
			...
			<div class="certificate-preview ${template}">
				...
				${
					...
					<section class="cannabis-determination">
						...
						<p class="cannabis-positive">Cannabis material detected in this caseObj.</p>
					</section>
				`
						: ""
				}
