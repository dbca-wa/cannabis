...
// Create case schema (matches CaseCreateSerializer)
...
// Update case schema (matches CaseUpdateSerializer)
...
export type CasesSearchFormData = z.infer<typeof submissionsSearchSchema>;
